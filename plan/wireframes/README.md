...
- [board-rules-visualiser-wireframe.md](board-rules-visualiser-wireframe.md): Board Rules Visualiser wireframe, repository/project selection, Reload from GitHub that keeps pickers (#449), Try again on unsupported boards, interactive diagram, rule detail and conflict panels, compare mode, and responsive layout.
- [workflow-templates-wireframe.md](workflow-templates-wireframe.md): Actions Templates page wireframe, custom template source selector plus manual field (#292), merged catalogue with source badges, parameter editor, apply-to-repository flow, status/feedback region, and responsive layout.
