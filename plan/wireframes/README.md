...
- [workflow-templates-wireframe.md](workflow-templates-wireframe.md): Actions Templates page wireframe, custom template source field (#292), merged catalogue with source badges, parameter editor, apply-to-repository flow, status/feedback region, and responsive layout.
