...
| 2026-08-31 | `v1.1 - Cross-Repo Planning & Refinement` delivery complete on GitHub (90 closed, 0 open). Remaining operator work is the `v1.1.0` tag. Custom template repositories (#292) and hosted private Projects v2 (#293) stay unmilestoned. | Solo developer |
