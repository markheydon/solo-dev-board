# Product chrome and UI quality — issue checklist

- [x] Epic: Product chrome and UI quality (#526).
...
- [x] Sub-issues set. No GitHub block from #529 onto parent #397 (child of the feature only).
- [x] Project #8 sync (no Phase; no dates).
