...
**Current roadmap status (2026-09-07):**
...
- Product visual language (DEC-039) is planned and unmilestoned. Branding [#397](https://github.com/markheydon/solo-dev-board/issues/397) stays ice-box. Mobile and narrow-viewport layout [#411](https://github.com/markheydon/solo-dev-board/issues/411) is an ice-box story under the visual language feature ([#527](https://github.com/markheydon/solo-dev-board/issues/527)). None of these is a v1.3 close-out gate unless promoted from dogfood.
