...
- [ ] Support custom template repositories — one GitHub `owner/name` source via catalogue selector or manual field, merged catalogue, localStorage last-used ([#292](https://github.com/markheydon/solo-dev-board/issues/292), [DEC-038](DECISIONS.md#dec-038-custom-actions-template-sources)).
...
**Status:** Open (declared 2026-08-31).

### Key Tasks

- [ ] Optional board-scoped Daily Focus recommendations, default remains all included repositories. _(#403)_
...
- [ ] Custom workflow template repositories: one GitHub YAML source (catalogue selector or manual field), inferred parameters, apply/drift parity, last-used localStorage. _(#292, DEC-038)_
...
4. #292 is specified to implement (DEC-038). Deliver the enabler (catalogue loader) then the dual source-picker UI (catalogue selector plus manual field) and tests. Do not ice-box again.
