...
- `.github/workflows/roadmap-sync.yml` is the operational bridge for the user-owned roadmap board. It reconciles board metadata from issue and pull request lifecycle events when direct project-board credentials are unavailable to the current agent runtime.
