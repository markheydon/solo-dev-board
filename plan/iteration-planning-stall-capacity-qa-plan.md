...
- `website/content/docs/planning.md` Iteration section states stall is a hard gate and capacity is a soft confirm.
...
2. Playwright asserts stall-alert `data-testid` on the `/planning/iteration` shell without requiring a live PAT.
