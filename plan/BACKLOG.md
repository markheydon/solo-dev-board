...
- [ ] As a solo developer, I want comprehensive unit tests for `GitHubService` and `GitHubAuthHandler` so that infrastructure reliability is verified. _(issue #10 — status/in-progress)_
