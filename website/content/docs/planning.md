...
![Planning — Daily Focus with SoloDevBoard Roadmap occupancy and recommendations](/images/planning/daily-focus.png)
...
3. You land on the **Daily Focus** tab (`/planning/daily-focus`).
...
![Planning Backlog Review with urgency panels for SoloDevBoard Roadmap](/images/planning/backlog.png)

### Accessing

1. Open **Planning**.
2. Select the **Backlog** tab (`/planning/backlog`).
...
![Planning Iteration with capacity, Up Next batch, and candidates](/images/planning/iteration.png)

### Accessing

1. Open **Planning**.
2. Select the **Iteration** tab (`/planning/iteration`).
...
![Planning Repo Management with SoloDevBoard Roadmap, thresholds, and filtered participation](/images/planning/repos.png)

### Accessing

1. Open **Planning**.
2. Select the **Repos** tab (`/planning/repos`).
