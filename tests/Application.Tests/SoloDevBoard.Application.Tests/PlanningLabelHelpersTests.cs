...
/// <summary>Tests for <see cref="PlanningLabelHelpers"/>.</summary>
public sealed class PlanningLabelHelpersTests
{
    [Theory]
    ...
    {
        var result = PlanningLabelHelpers.ParseTypeLabel(labels);
    ...
    {
        var result = PlanningLabelHelpers.ParsePriorityLabel(labels);
    ...
    {
        var result = PlanningLabelHelpers.ParseStatusLabel(labels);
    ...
    {
        Assert.Equal(expected, PlanningLabelHelpers.IsBlocked(labels));
    }
    ...
    {
        Assert.Equal(expected, PlanningLabelHelpers.IsIceBoxed(labels));
    }
    ...
    {
        Assert.Equal(expected, PlanningLabelHelpers.IsBlockedOrDeferred(labels));
    }
    ...
    {
        Assert.Equal(expected, PlanningLabelHelpers.IsUnblocked(labels));
    }
    ...
    {
        Assert.Equal(expected, PlanningLabelHelpers.IsAwaitingTriage(labels));
    }
    ...
    {
        Assert.Equal(expected, PlanningLabelHelpers.IsUrgent(labels));
    }
    ...
    {
        var result = PlanningLabelHelpers.IsEpicNearComplete([typeLabel, "priority/high"], total, completed);
