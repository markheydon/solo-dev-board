...
| `pm-workflow.spec.ts` | PM Workflow Daily Focus occupancy, recommendations, stalled Up Next, stalled-review, Backlog Review, and Iteration Planning shells, plus Repos tab threshold, exclusion, and summary regions or chrome error |
