...
| Label Manager taxonomy tabs, bulk delete shell, and empty repository state | `labels.spec.ts` | Tab strip, disabled bulk delete, and no-repositories message. |
