...
| Workflow template browse, filter, select, and custom source shell | `actions-templates.spec.ts` | Built-in templates load; custom source region and manual field are visible; apply repository selector shows error. |
