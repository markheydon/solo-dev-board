...
| PM Workflow Daily Focus and Repo Management shells | `pm-workflow.spec.ts` | Shared chrome, Daily Focus occupancy and stalled-review region or empty/error copy, Repos tab content or chrome error with retry. |
