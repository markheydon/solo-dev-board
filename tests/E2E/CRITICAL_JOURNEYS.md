...
| PM Workflow Daily Focus and Repo Management shells | `pm-workflow.spec.ts` | Shared chrome, Daily Focus occupancy, recommendations, and stalled-review regions or empty/error/warning copy, Repos tab thresholds, exclusions, and per-repository summary or chrome error with retry. |
