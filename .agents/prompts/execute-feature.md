...
- Follow layered architecture from `AGENTS.md`:
...
- Use MudBlazor components per `.agents/skills/mudblazor/SKILL.md` for UI work
...
### 4. Test Creation
- Add xUnit tests following `.agents/skills/csharp-xunit/SKILL.md`
