...
### Markdown Templates (`.agents/skills/github-issues/references/templates.md`)
- **Consumer:** AI agents creating issues via MCP tools (`mcp__github__create_issue`)
- **Format:** Markdown (API-compatible text format)
- **Location:** `.agents/skills/github-issues/references/templates.md`
...
2. **Update markdown template:**
   - Edit `.agents/skills/github-issues/references/templates.md`
...
3. **Update AI references:**
   ...
   - Check if `.agents/skills/github-issues/SKILL.md` needs updates
...
- **AI issue creation:** `.agents/skills/github-issues/SKILL.md`
