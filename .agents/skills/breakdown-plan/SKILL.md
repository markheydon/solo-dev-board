...
1. **Scope and planning context**: `plan/SCOPE.md`, GitHub Issues, and Project #8
2. **Implementation roadmap**: `plan/IMPLEMENTATION_PLAN.md`
3. **Label taxonomy**: `plan/LABEL_STRATEGY.md`
...
1. **Project Plan**: `plan/{epic-name}-{feature-name}-project-plan.md`
2. **Issue Creation Checklist**: `plan/{epic-name}-{feature-name}-issues-checklist.md`
...
| -------- | ------ | ------------------------------- | --------------------------------- |
| P0       | High   | Critical path, blocking release | `priority/critical` |
| P1       | High   | Core functionality, user-facing | `priority/high`     |
| P1       | Medium | Core functionality, internal    | `priority/high`     |
| P2       | Medium | Important but not blocking      | `priority/medium`   |
| P3       | Low    | Nice to have, technical debt    | `priority/low`      |
...
1. **Backlog**: Prioritised and ready for planning
...
#### Story/Enabler Level Issues documented in `plan/{epic-name}-{feature-name}-issues-checklist.md`

- [ ] **User stories created** following INVEST criteria
- [ ] **Technical enablers identified** and prioritised
