...
- Follow layered architecture rules from `AGENTS.md`:
...
- Use MudBlazor components per `.agents/skills/mudblazor/SKILL.md` when building UI
...
### 4. Test Creation
- Add or update xUnit tests following `.agents/skills/csharp-xunit/SKILL.md`
...
- Add XML doc comments (`///`) to all public members per `.agents/skills/csharp-docs/SKILL.md` (in-code comments are Delivery Agent's responsibility)
...
- `AGENTS.md` — coding standards, architecture rules
...
- `.agents/skills/csharp-xunit/SKILL.md` — testing standards
- `.agents/skills/csharp-docs/SKILL.md` — documentation standards
- `.agents/skills/mudblazor/SKILL.md` — UI component patterns
...
Before marking implementation complete, validate against mandatory gates from `AGENTS.md`:
