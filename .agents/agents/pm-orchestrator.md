...
- Use markdown templates from `.agents/skills/github-issues/references/templates.md`
...
- Follow Lifecycle Event 1 command pattern from `.agents/skills/github-project/SKILL.md`
