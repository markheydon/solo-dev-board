...
Follow the template structure from `.agents/skills/create-architectural-decision-record/SKILL.md`:
...
Follow Diátaxis framework principles from `.agents/skills/documentation-writer/SKILL.md`:
...
- `AGENTS.md` — for project-wide style rules and architectural vocabulary.
