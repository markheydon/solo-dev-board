...
public interface IActionsTemplateService
{
    ...
    Task<IReadOnlyList<ActionsTemplateDto>> GetTemplatesAsync(CancellationToken cancellationToken = default);
    ...
    Task<ActionsTemplateDetailDto> GetTemplateDetailAsync(int templateId, CancellationToken cancellationToken = default);
