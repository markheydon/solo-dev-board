...
public static class PlanningWorkItemJoinKey
{
    ...
    public static string For(PlanningWorkItemDto item)
    {
        ArgumentNullException.ThrowIfNull(item);
        return For(item.ItemType == PlanningWorkItemTypeDto.PullRequest, item.RepositoryFullName, item.Number);
    }
