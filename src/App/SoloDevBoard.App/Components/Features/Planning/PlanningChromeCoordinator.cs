...
/// </summary>
public sealed class PlanningChromeCoordinator
{
    ...
    /// <summary>Initialises a new instance of the <see cref="PlanningChromeCoordinator"/> class.</summary>
    ...
    public PlanningChromeState State { get; } = new();
