...
/// <summary>Repo Management panel rendered inside <see cref="PlanningShell"/>.</summary>
public partial class PlanningReposPanel : ComponentBase, IDisposable
{
    [CascadingParameter]
    ...
    [Inject]
    public IPlanningWorkItemCatalogueService WorkItemCatalogueService { get; set; } = default!;

    [Inject]
    public ILogger<PlanningReposPanel> Logger { get; set; } = default!;

    private int capacity = PlanningSettingsDefaults.Capacity;
    private int stallDays = PlanningSettingsDefaults.StallDays;
    private int neglectDays = PlanningSettingsDefaults.NeglectDays;
    ...
    private IReadOnlyList<PlanningRepositorySummaryDto> repositorySummaries = [];
    private IReadOnlyList<PlanningRepositoryCatalogueFailureDto> summaryFailures = [];
