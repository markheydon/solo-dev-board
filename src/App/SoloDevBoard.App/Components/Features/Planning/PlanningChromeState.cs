...
public sealed class PlanningChromeState
{
    /// <summary>Gets or sets the effective PM settings.</summary>
    public PlanningSettingsDto Settings { get; set; } = PlanningSettingsDefaults.Create();
    ...
    public IReadOnlyList<PlanningBoardOptionDto> PlanningBoardOptions { get; set; } = [];
    ...
    public Func<PlanningSettingsDto, Task> SaveSettingsAsync { get; set; } = _ => Task.CompletedTask;
