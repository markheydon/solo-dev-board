...
- **Local Development:** Use `dotnet user-secrets` for legacy `dotnet run` path, or `aspire secret set` for Aspire AppHost. See `docs/getting-started.md` for setup instructions.
...
| New env variable | `docs/getting-started.md`, `src/SoloDevBoard.AppHost/README.md`, `docs/deployment.md` |
