...
1. **Test Strategy**: `plan/{epic-name}-{feature-name}-test-strategy.md`
2. **Test Issues Checklist**: `plan/{epic-name}-{feature-name}-test-issues-checklist.md`
3. **Quality Assurance Plan**: `plan/{epic-name}-{feature-name}-qa-plan.md`
...
## Acceptance Criteria
{Acceptance criteria for the story/component}

## Labels
`playwright`, `e2e-test`, `istqb`, `iso25010`

## Estimate
{Implementation effort: 2-3 story points}
```
